...
public class Program
{
	static public void Main()
	{
		...
		// в цикле while для сравнения с Boolean можно не использовать оператор сравнения. достаточно написать просто саму переменную (если проверка на true) или с восклицательным знаком (если проверка на false):
		
		// while(b) или while(!b)
		
		
		// переменной Boolean присвоится True или False в зависимости от того, как вычисляется оператор:
