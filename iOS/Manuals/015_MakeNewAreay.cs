...
public class Program
{
	static public void Main()
	{
		...
		// второй метод  основан на том, чтобы при обращении к методу WriteLine указать метод вывода на монитор массива String.Join, а в месте аргумента указать метод ReadLine с методом Split, позволяющим заполнить массив данеыми из консоли, введенными через пробел. но в данном методе массив не сохраняется в программе:
