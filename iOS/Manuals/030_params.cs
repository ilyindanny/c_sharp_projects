...
double Average(double[] array) // это просто метод, возвращающий среднеарифметическое
	...
	// ключевое слово params указанное в параметре метода, позволяет при вызове метода в качестве аргумента вводить сразу числа или переменные. в следующем примере в качестве одного из аргументов после запятой указан метод:
