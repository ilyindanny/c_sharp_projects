...
public class MyMethods
{
	...
	/// <Summary>
	/// подсчет суммы элементов массива, стоящих на основной диагонали-биссектрисе
	/// </Summary>
	...
	/// <Summary>
	/// замена значений в массиве на нули всех элементов, кроме находящихся на основной диагонали-биссектрисе
	/// </Summary>
